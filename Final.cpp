...
int main()
{
	...
	Model trex("resources/objects/T-Rex/T-Rex.obj");
	Model Banco("resources/objects/Banco/Bank_02.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//model = glm::rotate(model, glm::radians(rot200), glm::vec3(0.0f, 1.0f, 0.0f));    //rotación para mover 180 el auto
